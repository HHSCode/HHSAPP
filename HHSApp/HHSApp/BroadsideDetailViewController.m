...
-(void)loadWebView:(int)indexPath :(NSMutableArray *)stories{
    NSLog(@"setwebview");
    ...
    NSLog(@"Loading URL");
    [self.broadsideDetailWebView loadHTMLString:final baseURL:[NSURL URLWithString:@"hanoverhigh.us"]];
    //[self.broadsideDetailWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"www.google.com"]]];
}
